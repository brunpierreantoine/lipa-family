export const DEFAULT_FAMILY_PROFILE = `Nous vivons au Vietnam.
La famille est composée de deux parents : Pierre (né en mars 1988) et Lisa (née en mars 1989).
Les histoires sont destinées à deux jeunes garçons : Jules (né en octobre 2019) et Théodore (né en mai 2021).
